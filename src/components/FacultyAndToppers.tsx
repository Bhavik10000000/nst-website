...
export function FacultyAndToppers({ onOpenRegistry }: FacultyAndToppersProps) {
  ...
  const mainToppers = [
    ...
    },
    {
      ...
      subInfo: "Saraswati Vidyalaya, Vasind",
      stream: "10th Board / Math & Eng",
    },
  ];

  return (
    <section
      className="py-16 md:py-24 bg-white border-b border-art-black"
      id="faculty-toppers"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 border-b border-art-black pb-8">
          <div className="max-w-2xl">
            <span className="art-label text-art-red mb-2 block font-bold">
              Academic Leadership & Merits
            </span>
          ...
          <p className="art-label opacity-40 max-w-xs md:text-right mt-4 lg:mt-0 leading-relaxed text-[11px]">
            Guided by Nikhil Shewale Sir. Consistent results with 10 years of
            bright success in competitive exams.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch mb-16">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between border border-art-black p-8 hover:bg-neutral-50 transition-all group">
            <div>
              <div className="flex justify-between items-start mb-6">
                <span className="px-3 py-1 bg-art-red text-white art-label text-[9px] font-bold">
                  FOUNDER &amp; DIRECTOR
                </span>
              ...
              <h3 className="text-3xl md:text-4xl font-serif italic mb-1 text-art-black">
                {facultyMembers[0].name}
              </h3>
              <div className="art-label text-art-red mb-6 tracking-wide text-xs">
                {facultyMembers[0].role} / {facultyMembers[0].experience}
              </div>
            ...
            <div className="border-t border-art-black pt-4 mt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              >
                View Leadership Credentials{" "}
                <ChevronRight className="w-3.5 h-3.5 text-art-red" />
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 border border-art-black bg-art-black p-8 text-white flex flex-col justify-between">
            <div>
              <span className="art-label text-art-red mb-6 block font-sans tracking-[0.2em] text-[10px]">
                NST PRINCIPLES
              </span>
              <h4 className="text-2xl font-serif italic mb-6 text-white border-b border-white/10 pb-3">
                Pillars of Academic Rigor
              </h4>

              <div className="space-y-4">
                {coreFeatures.slice(0, 4).map((feat, idx) => (
                  <div key={idx} className="flex gap-3 items-start">
                    <span className="text-[10px] font-mono text-art-red px-1 bg-white/5 border border-white/15">
                      0{idx + 1}
                    </span>
                    <p className="text-xs font-sans text-neutral-300 leading-normal">
                      {feat.text}
                    </p>
                  </div>
                ))}
            ...
            <div className="mt-8 pt-4 border-t border-white/10 flex items-center justify-between">
              ...
              <span className="text-[9px] text-art-red font-mono font-bold tracking-wider">
                EST. 2012
              </span>
            </div>
          </div>
        ...
        <div id="quick-toppers" className="mb-12">
          <div className="border-t border-art-black pt-10 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="art-label text-art-red mb-1 block text-xs">
                Wide Stream Representation
              </span>
              <h3 className="text-2xl md:text-3xl font-serif italic text-art-black">
                Elite Board & Competitive Toppers
              </h3>
            </div>
              ...
              >
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <span className="text-[9px] text-art-red font-bold uppercase tracking-wider">
                      {topper.stream}
                    </span>
                  ...
                  <h4 className="text-base font-serif italic text-art-black font-semibold group-hover:text-art-red transition-colors">
                    {topper.name}
                  </h4>
        ...
        <div className="bg-neutral-50 border border-neutral-200 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-sans font-bold text-neutral-800">
                Complete Board Registry Validated
              </h4>
              <p className="text-[10px] text-neutral-500 leading-none">
                Class 10th &amp; 12th state transcripts are fully authenticated.
              </p>
            </div>
          </div>
          <button
          ...
          >
            INSPECT FULL MERIT REGISTRY &amp; ARCHIVE{" "}
