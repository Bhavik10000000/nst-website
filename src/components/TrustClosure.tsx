    ...
    <section className="py-16 md:py-24 bg-art-bg border-y border-art-black px-6">
      <div className="container mx-auto max-w-5xl">
        <div className="flex flex-col items-center text-center">
          <span className="art-label text-art-red mb-4 md:mb-8 block font-bold">
            Voice of Experience (Alumni)
          </span>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <div className="art-label mb-1 text-art-black font-bold text-xs">
                  {testimonials[active].name}
                </div>
                <div className="text-[10px] tracking-wider uppercase text-art-red font-mono font-bold">
  ...
  return (
    <section className="bg-art-black text-white py-10 overflow-hidden border-b border-art-black">
      ...
      <div className="container mx-auto px-6 py-10 text-center">
        <span className="art-label text-art-red mb-4 block font-bold">
          Limited Strategic Enrolment / Autumn Term
        </span>
        <h2 className="text-3xl sm:text-5xl md:text-[64px] font-serif font-black tracking-tighter leading-none mb-10 text-white">
          Secure Your Success.
        </h2>

        <div className="max-w-2xl mx-auto mb-10 border border-art-red p-6 bg-art-red/5">
          <div className="art-label text-art-red mb-3 font-semibold">
            Status: Limited Batches
          </div>
          <h3 className="text-xl md:text-3xl font-serif italic mb-4 leading-snug">
          ...
          <p className="art-label opacity-40 text-[9px]">
            Strategic Profiles Selected across Vasind.
          </p>
        </div>
