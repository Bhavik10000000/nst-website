...
import { X, Search, Award, GraduationCap, CheckCircle2, ChevronRight, BookOpen, Star, Sparkles } from 'lucide-react';
...
export function AcademicRegistry({ isOpen, onClose, initialTab = 'all' }: AcademicRegistryProps) {
  ...
  const classTenToppers = [
    { name: "Vaishnavi Dubhele", score: "96.80%", detail: "1st Rank (97/100 Maths)", school: "Saraswati Vidyalaya, Vasind", category: "10th" },
    { name: "Parth Kathole", score: "95.00%", detail: "1st Rank (98/100 Science)", school: "New Ideal School, Vasind", category: "10th" },
    { name: "Bhavik Sapat", score: "94.80%", detail: "2nd Rank (98/100 English & 98/100 Maths)", school: "Saraswati Vidyalaya, Vasind", category: "10th" },
    { name: "Diksha Late", score: "94.20%", detail: "2nd Rank Overall", school: "New Ideal School, Vasind", category: "10th" },
    { name: "Nimisha Vishe", score: "94.00%", detail: "3rd Rank Overall", school: "New Ideal School, Vasind", category: "10th" },
    { name: "Poonam Keyare", score: "93.80%", detail: "Elite List", school: "Board Excellence", category: "10th" },
    { name: "Samiksha Thakare", score: "93.20%", detail: "Elite List", school: "Concept Champion", category: "10th" },
    { name: "Vaishnavi Thakare", score: "92.80%", detail: "Elite List", school: "Maths Prodigy", category: "10th" },
    { name: "Tanmay Pawar", score: "90.80%", detail: "Elite List", school: "High Achiever", category: "10th" },
    { name: "Sonali Das", score: "90.60%", detail: "Elite List", school: "High Achiever", category: "10th" },
    { name: "Diksha Vishe", score: "90.60%", detail: "Elite List", school: "High Achiever", category: "10th" },
    { name: "Pranav Jadhav", score: "89.80%", detail: "Board Excellence", school: "NST Foundation", category: "10th" },
    { name: "Mayuresh Gaikwad", score: "89.60%", detail: "Board Excellence", school: "NST Foundation", category: "10th" },
    { name: "Vedika Patil", score: "89.20%", detail: "Board Excellence", school: "NST Foundation", category: "10th" },
    { name: "Priya Patil", score: "89.20%", detail: "Board Excellence", school: "NST Foundation", category: "10th" },
    { name: "Atharva Kadam", score: "89.00%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Divya Patil", score: "89.00%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Ritesh Kadu", score: "88.00%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Sakshi Shelar", score: "88.20%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Mrunal Patil", score: "87.20%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Jagdish Choudhary", score: "86.80%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Sumit Mishra", score: "86.80%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Dipti Mohe", score: "86.80%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Neha Mhaskar", score: "86.40%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
    { name: "Manika Bhore", score: "86.00%", detail: "Excellent Results", school: "NST Foundation", category: "10th" },
  ];
  ...
  const filteredToppers = allToppers.filter(topper => {
    ...
    if (activeTab === 'competitive' && topper.category !== 'competitive') return false;
    
    // Search search term
    if (searchTerm) {
      const term = searchTerm.toLowerCase();
      return topper.name.toLowerCase().includes(term) || 
        ...
        >
          ...
          <div className="px-6 py-6 md:px-10 md:py-8 border-b border-art-black flex items-center justify-between bg-neutral-50">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2 py-0.5 bg-art-red text-white text-[8px] tracking-widest art-label">NST HONOURS REGISTRY</span>
                <span className="text-xs font-serif italic text-neutral-400">10 Years of Excellence</span>
              </div>
              <h2 className="text-xl md:text-3xl font-serif italic font-black text-art-black">The Directorial & Merit Roll</h2>
            </div>
            ...
            {activeTab === 'faculty' ? (
              ...
              <div className="max-w-4xl mx-auto space-y-12">
                {facultyMembers.map((member, idx) => (
                  <div key={idx} className="border border-art-black bg-white p-6 md:p-10 hover:shadow-lg transition-shadow">
                    <div className="flex flex-col md:flex-row justify-between items-start gap-6 border-b border-neutral-100 pb-6 mb-6">
                      <div>
                        <span className="px-2 py-0.5 bg-art-red text-white text-[8px] art-label font-bold mb-3 inline-block">ACADEMIC FOUNDER</span>
                        <h3 className="text-3xl md:text-4xl font-serif italic text-art-black">{member.name}</h3>
                        <p className="art-label text-art-red text-xs mt-1">{member.role} — {member.experience}</p>
                      </div>
                      <div className="text-right">
                        <span className="art-label opacity-40 text-[9px]">CLASSES TAUGHT</span>
                        <p className="text-sm font-sans font-medium text-neutral-800">5th to 10th &amp; 11th - 12th Science / Board Prep</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                      <div>
                        <h4 className="art-label text-[9px] opacity-40 mb-3">PROFESSIONAL SPECIALIZATION</h4>
                        <div className="space-y-2 mb-6">
                          {member.specialty.map((spec, sIdx) => (
                            <div key={sIdx} className="flex items-center gap-2">
                              <CheckCircle2 className="w-4 h-4 text-art-red shrink-0" />
                              <span className="text-xs text-neutral-800 font-sans font-medium">{spec}</span>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="border-l border-neutral-200 pl-0 md:pl-8 pt-6 md:pt-0 flex flex-col justify-between h-full">
                        <div>
                          <span className="art-label text-[9px] opacity-40 mb-3 block">DIRECTOR'S STATEMENT</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-6">
                  <span className="text-[10px] art-label text-neutral-400">SHOWING {filteredToppers.length} ELITE RESULTS</span>
                  {authTokenMessage()}
                </div>

                {filteredToppers.length === 0 ? (
                  <div className="text-center py-20 border border-neutral-200 bg-white">
                    <p className="text-sm text-neutral-500 font-serif italic">No matching academic records found. Try adjusting your search keyword.</p>
                  </div>
                ) : (
                        ...
                        <div>
                          <div className="flex justify-between items-center mb-4">
                            <span className="px-2 py-0.5 bg-neutral-100 text-neutral-600 text-[8px] font-mono tracking-widest font-bold">
                              {topper.category === '12th' ? '12TH SCIENCE' : topper.category === 'competitive' ? 'COMPETITIVE' : '10TH BOARD'}
                            </span>
                          ...
                          <p className="text-[9px] art-label font-bold text-art-red mb-2">{topper.detail}</p>
                        </div>

                        <div className="border-t border-neutral-100 pt-3 mt-4">
                          <p className="text-[10px] text-neutral-400 leading-snug font-sans">{topper.school}</p>
                          <p className="text-[8px] art-label text-neutral-300 tracking-wider mt-1">{(topper as any).stream || "10th Board Foundation"}</p>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="px-6 py-4 md:px-10 border-t border-art-black bg-art-black text-white flex flex-col sm:flex-row items-center justify-between gap-4">
            <span className="art-label text-[8px] opacity-60 tracking-widest text-neutral-300 text-center sm:text-left">
              * CRASH COURSE &amp; BOARD ADMISSIONS OPEN: LIMITED TO 30 STRATEGIC PROFILES PER YEAR.
            </span>
  ...
  function authTokenMessage() {
    return (
      <div className="flex items-center gap-1">
        ...
        <span className="text-[8px] art-label text-neutral-400 tracking-wider font-bold">VERIFIED BOARD RECORDS</span>
      </div>
    );
  }
}
