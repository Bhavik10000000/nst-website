  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 md:gap-12">
        <a
          href="#"
          className="text-2xl md:text-3xl font-black italic uppercase tracking-tighter text-art-black select-none"
        >
          NST.
        </a>
        ...
        <div className="hidden md:flex items-center gap-12">
          ...
          <a
            href="#contact"
            className="art-button px-6 h-10 flex items-center justify-center text-[10px]"
          >
            Enroll
          </a>
        </div>
        ...
        >
          {mobileMenuOpen ? (
            <X className="w-5 h-5 text-art-black" />
          ) : (
            <Menu className="w-5 h-5 text-art-black" />
          )}
        </button>
      </div>
